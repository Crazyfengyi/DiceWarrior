...
namespace YangTools
{
    ...
    public class YangEventManager
    {
        ...
        /// 事件字典
        /// </summary>
        private readonly Dictionary<string, SortedList<int, List<EventInfo>>> eventDic =
            new Dictionary<string, SortedList<int, List<EventInfo>>>();
    ...
    {
        private readonly Dictionary<string, List<Action<EventData>>> groupCachedListener =
