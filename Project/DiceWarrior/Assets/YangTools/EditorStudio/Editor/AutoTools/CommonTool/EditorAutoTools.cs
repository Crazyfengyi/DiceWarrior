...
namespace YangTools
{
    ...
    public static partial class EditorAutoTools
    {
        ...
        {
            Debug.Log(
                $"cmd:{cmd.Colored("green")} argument:{argument.Colored("green")} wait:{wait.ToString().Colored("green")}");
        ...
        static SpriteMetaData GetSpriteMetaData(string Name, Rect Rect, Vector2 Pivot, Vector4 Border,
            int AlignmentType)
        {
