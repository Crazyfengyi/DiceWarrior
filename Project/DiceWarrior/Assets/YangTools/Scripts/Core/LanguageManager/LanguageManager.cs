...
public class LanguageManager : MonoSingleton<LanguageManager>
{
    ...
    private TBLanguageCategory tableData;

    public void Start()
    {
        TBLanguageCategory tableData = GameTableManager.Instance.Tables.TBLanguageCategory;
        Type type = typeof(TBLanguageCategory);
        //获取所有实例属性
